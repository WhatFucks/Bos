<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.destination" placeholder="请输入到达地" style="width: 200px;" class="filter-item"/>
    ...
    >
      ...
      <el-table-column label="入库人" align="center" min-width="150px">
        <template slot-scope="{row}">
...
<!--      </el-table-column>-->
      ...
      <el-table-column label="重量"  width="150px" align="center">
        <template slot-scope="{row}">
...
<script>
  import { list } from '@/api/body/ljw/departure'
    ...
    methods: {
      ...
      getList() {
        ...
        list(this.listQuery).then(response => {
          ...
          console.debug("工作党")
          console.debug(this.list.sorCheckbounddetails)
          this.Sorlist = response.data.Sorlist
        })
